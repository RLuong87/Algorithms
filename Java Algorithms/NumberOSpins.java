...
public class NumberOSpins {
    ...
    public static void main(String[] args) {
        ...
        String[] spin = {"right", "right", "right", "right", "right", "right", "right", "right"};
        int count = 0;
